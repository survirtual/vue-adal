...
function () {
  ...
  function AuthenticationContext(opts) {
    ...
    var _this = this; // Initialization to options or default
...
var getToken = function getToken(resource, http, cb) {
  exports.AuthenticationContext.acquireToken(resource, function (err, token) {
    ...
    http.defaults.headers['Authorization'] = "BEARER ".concat(token);
    cb(null, token);
  });
};
...
function () {
  function AxiosAuthHttp() {
    _classCallCheck(this, AxiosAuthHttp);
  }

  _createClass(AxiosAuthHttp, null, [{
    key: "createNewClient",
